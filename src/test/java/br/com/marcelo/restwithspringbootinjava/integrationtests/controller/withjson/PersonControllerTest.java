package br.com.marcelo.restwithspringbootinjava.integrationtests.controller.withjson;
...
import br.com.marcelo.restwithspringbootinjava.integrationtests.vo.PersonVO;
...
public class PersonControllerTest extends AbstractIntegrationTest {
	...
	public void testFindByIdWithWrongOrigin() throws JsonProcessingException {
		...
		var content = given().spec(specification)
				...
				.asString();
		assertNotNull(content);
		assertEquals("Invalid CORS request",content,"Domínio de requisição não aceito!");
	}
